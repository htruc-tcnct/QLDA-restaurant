...
const HERO_IMAGE = "/images/menu/Bào Ngư Sốt Dầu Hào/pixabay_1255020_06.jpg";

// Map tên món sang đường dẫn folder ảnh
const FOLDER_IMAGE_MAP = {
  "Heo Sữa Quay Da Giòn": "/images/menu/Heo Sữa Quay Da Giòn/pixabay_2480295_01.jpg",
  "Tôm Càng Xanh Sốt Me": "/images/menu/Tôm Càng Xanh Sốt Me/pixabay_4773380_05.jpg",
  "Miến Xào Cua Bể": "/images/menu/stir-fried_glass_noodles_with_crab/pixabay_6405452_02.jpg",
  "Đĩa Tráng Miệng Việt Cao Cấp": "/images/menu/Đĩa Tráng Miệng Việt Cao Cấp/pixabay_5582984_01.jpg"
};
...
const HomePage = () => {
  ...
  const getImageUrl = (url, dishName) => {
    ...
    // Nếu tên món trùng folder thì lấy ảnh đầu tiên trong folder đó
    if (dishName && FOLDER_IMAGE_MAP[dishName]) {
      return `http://localhost:5000${FOLDER_IMAGE_MAP[dishName]}`;
    }
    // Mặc định trả về ảnh Bào Ngư Sốt Dầu Hào
    return "http://localhost:5000/images/menu/Bào Ngư Sốt Dầu Hào/pixabay_1255020_06.jpg";
  };
      ...
      <section className="hero bg-dark text-white py-5">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-6">
              <img 
                src={getImageUrl(HERO_IMAGE, null)}
                alt="Restaurant hero" 
            ...
            {featuredDishes.length > 0 ? featuredDishes.map((item) => (
              <div key={item._id} className="col-md-4 mb-4">
                <div className="card h-100">
                  <img 
                    src={getImageUrl(item.imageUrls?.[0], item.name)}
                    className="card-img-top" 
                    alt={item.name}
                    style={{ height: '200px', objectFit: 'cover' }}
                    onError={(e) => { e.target.onerror = null; e.target.src = getImageUrl(null, item.name); }}
                  />
      ...
      <section className="about py-5 bg-light">
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-6">
              <img 
                src={getImageUrl(aboutDish?.imageUrls[0], null)} 

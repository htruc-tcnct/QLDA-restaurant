...
const NO_IMAGE_PLACEHOLDER = "data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 80 80' width='80' height='80'%3e%3crect width='100%25' height='100%25' fill='%23e9ecef'/%3e%3ctext x='50%25' y='50%25' font-size='10' text-anchor='middle' alignment-baseline='middle' font-family='sans-serif' fill='%236c757d'%3eNo Image%3c/text%3e%3c/svg%3e";
                  ...
                  <tbody>
                    {menuItems.map(menuItem => (
                      <tr key={menuItem._id}>
                        <td>
                          <Image 
                            src={getImageUrl(menuItem.imageUrls?.[0])}
                            alt={menuItem.name}
                            width={60}
                            height={60}
                            ...
                            onError={(e) => {
                              ...
                              const randomIndex = Math.floor(Math.random() * ALL_MENU_IMAGE_URLS.length);
                              e.target.src = `http://localhost:5000${encodeURI(ALL_MENU_IMAGE_URLS[randomIndex])}`;
                            }}
                          />
                        </td>
                        <td>

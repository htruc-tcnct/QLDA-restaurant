        ...
        <Card.Body>
          ...
          {filteredTables.length > 0 && (
            <div className="d-flex justify-content-between align-items-center mt-3">
              <div>
                Hiển thị {indexOfFirstTable + 1} -{" "}
                {Math.min(indexOfLastTable, filteredTables.length)} /{" "}
          ...
          <Form onSubmit={handleSubmit}>
            ...
            {modalMode !== "add" && (
              <Form.Group className="mb-3">
                ...
                {modalMode === "view" && formData.status === "available" && (
                  <Form.Text className="text-muted">
                    Bàn đang trống và sẵn sàng sử dụng
                  </Form.Text>
                )}
              </Form.Group>
            )}
